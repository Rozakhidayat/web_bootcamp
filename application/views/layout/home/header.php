        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('Categories_home/Sayur') ?>" class="side-menu side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('Categories_home/Buah') ?>" class="side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('Categories_home/Umbi') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="feather"></i> </div>
                            <div class="side-menu__title"> Tubers </div>
                        </a>
                    </li>
