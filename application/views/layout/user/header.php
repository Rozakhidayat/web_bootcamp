    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <span class="text-white text-lg ml-3"> FreshGreen </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('Categories/Sayur') ?>" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i data-lucide="carrot"></i> </div>
                            <div class="side-menu__title">
                                Vegetables
                                <div class="side-menu__sub-icon transform rotate-180"> </div>
                            </div>
                        </a>
                        <a href="<?= base_url('Categories/Buah') ?>" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i class='fa fa-apple' style='font-size:20px'></i> </div>
                            <div class="side-menu__title">
                                Fruits
                                <div class="side-menu__sub-icon transform rotate-180"> </div>
                            </div>
                        </a>
                        <a href="<?= base_url('Categories/Umbi') ?>" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i data-lucide="feather"></i></div>
                            <div class="side-menu__title">
                                Tubers
                                <div class="side-menu__sub-icon transform rotate-180"> </div>
                            </div>
                    ...
                    <li>
                        <a href="<?= base_url('bill') ?>" class="side-menu">
                            ...
                            <div class="side-menu__title"> Confirm Pay </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?= base_url('pay') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> History Pay </div>
                        </a>
                    </li>
